...
var variable0=expression.getValue("ASI::GENERAL WORK INFORMATION::ROW Permit No.");
		...
		if (capResult.getSuccess()) {
			...
			if (licCap != null) {
				...
				appTypeArray = appTypeString.split("/");
 				if (appTypeArray[0] == "Engineering" && appTypeArray[1] == "Right Of Way")
					valueOk = true;
			}
		}
	}
