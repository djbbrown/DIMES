...
if (wfTask == 'Distribution' && wfStatus == 'Distributed') {
	...
	var vDateFrom;
	var vDateTo;
	var vSubmittalBuffer = lookup('SetDueDates:Planning/Design Review/NA/NA', 'Submittal Buffer (Days)');
	var vTotalTimeTillHearing = vSubmittalBuffer + lookup('SetDueDates:Planning/Design Review/NA/NA', 'Time Till Hearing (Days)'); ;
	...
	//Set Due Dates
	setWFDueDate_Mesa('SetDueDates:Planning/Design Review/NA/NA', vScheduledDate);
}