/*===================================================================
// Script Number: 37
// Script Name: ENF_Ongoing_Status.js
// Script Description: Send an email to the complainant when Inpection Updates & ASI field "Notify Complainant" has a value of "Y" or "Yes"
...
try {
      ...
      //Check Notify Complainant
      Notify = AInfo["Notify Complainant"];
      if (Notify == "Yes")
        {
