...
)
{
	...
	if(appTypeArray[2]=="SpecialEvent"
		...
		editAppSpecific("Substantive Review Due", dateAdd(AInfo["Administrative Review Date"],30));
	}else if(appTypeArray[2]=="MassageEstablishment") {
		editAppSpecific("Substantive Review Due", dateAdd(AInfo["Administrative Review Date"],90));
		...
		editAppSpecific("Substantive Review Due", dateAdd(AInfo["Administrative Review Date"],45));
	}else{
		// Update the Substantive Review Due + 60 for all other record types.
		editAppSpecific("Substantive Review Due", dateAdd(AInfo["Administrative Review Date"],60));
	}
}