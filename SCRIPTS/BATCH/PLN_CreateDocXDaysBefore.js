...
// Create a Requirement/COA for Site Posting Affidavit 14 business days prior to the hearing date.
// Create a Requirement/COA for Prop 207 Report 10 business days prior to the hearing date
// Create a Requirement/COA for Notification Letters 14 business days prior to the hearing date
...
//  1.0      |09/19/16  |Vance Smith      |Initial
/*==================================================================*/
    ...
    for (var myCap in myCaps) 
    {
        ...
        */
        ...
        for (t in tasks) {
            ...
            tActive = tasks[t].getActiveFlag(); // we will only want to work with the active items, this should do it.
            if (tActive == 'Y') {
                updateTask(tName, "Expired", "set by batch", ""); // this is in INCLUDES_ACCELA_FUNCTIONS
        ...
        */
        ...
        /* TASKS, WORKFLOW, AND UPDATE STATUS EXAMPLE -- COMPLICATED EXAMPLE!
