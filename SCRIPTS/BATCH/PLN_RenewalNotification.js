...
function mainProcess()
{
    ...
    aa.sendMail("NoReply@MesaAz.gov", emailAdminTo, emailAdminCc, "Batch Script: PLN_RenewalNotification Completion Summary", emailText);
...
try 
{
    ...
    if ( batchJobName == "" ) // batchJobName will be empty string when using the script tester
    {
        ...
        aa.env.setValue("emailTemplate", "PLN_RenewalNotification");
