...
function mainProcess() 
{
    ...
    logDebug("Query results: " + queryResultsCount + " Records ");
    ...
    aa.sendMail("NoReply@MesaAz.gov", "vance.smith@mesaaz.gov", "lauren.lupica@mesaaz.gov", "Batch Script: PMT_ExpirationNotice Completion Summary", emailText);
