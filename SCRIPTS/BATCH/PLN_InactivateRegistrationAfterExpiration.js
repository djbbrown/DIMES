/*===================================================================
// Script Number: 266
// Script Name: PLN_InactivateRegistrationAfterExpiration
...
function mainProcess() 
{
    ...
    for (var myCap in myCaps) 
    {
        ...
        // move to the next record if days since expiration is not equal to 1 (expiration was yesterday)
        ...
        // expire the active tasks, close the workflow, and then set the record status to inactive
    ...
    logDebugAndEmail("Skipped " + capFilterDaysPastExp + " due to not being " + numDaysOut + " days past expiration");

    logDebugAndEmail(""); // empty line
    logDebugAndEmail("-------------------------");
    logDebugAndEmail("End of Job: Elapsed Time : " + elapsed() + " Seconds");
    aa.sendMail("NoReply@MesaAz.gov", emailAdminTo, emailAdminCc, "Batch Script: PLN_InactivateRegistrationAfterExpiration Completion Summary", emailText);
