...
var toDate = getParam("toDate");						// 05                                           // ""
var dFromDate = aa.date.parseDate(fromDate);			//
var dToDate = aa.date.parseDate(toDate);				//
var lookAheadDays = aa.env.getValue("lookAheadDays");	// 10 Number of days from today
var daySpan = aa.env.getValue("daySpan");				// 20 Days to search (6 if run weekly, 0 if daily, etc.)
